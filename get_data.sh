...
seqkit subseq --gtf data/gencode.v40.annotation.pc.unique.gtf data/GRCh38.primary_assembly.genome.fa -u 1024 -d 1024 > data/gencode.v40.annotation.pc.unique.fa

#should match above wc call for the .gtf file
grep -c ">" data/gencode.v40.annotation.pc.unique.fa

#temp
cat data/gencode.v40.annotation.pc.unique.fa | seqkit subseq -r 1:512 > posu1024u512.fa
cat data/gencode.v40.annotation.pc.unique.fa | seqkit subseq -r 513:1024 > posu512.fa
cat data/gencode.v40.annotation.pc.unique.fa | seqkit subseq -r 1025:1536 > posd512.fa
cat data/gencode.v40.annotation.pc.unique.fa | seqkit subseq -r 1537:2048 > posd512d1024.fa

#double check above command worked
seqkit stats posu1024u512.fa
seqkit stats posu512.fa
seqkit stats posd512.fa
seqkit stats posd512d1024.fa
...
cat UU_all_merged.fa | seqkit subseq -r 1:512 > ../negu1024u512.fa
cat UU_all_merged.fa | seqkit subseq -r 513:1024 > ../negu512.fa
cat UU_all_merged.fa | seqkit subseq -r 1025:1536 > ../negd512.fa
cat UU_all_merged.fa | seqkit subseq -r 1537:2048 > ../negd512d1024.fa

cd ..
seqkit stats negu1024u512.fa
seqkit stats negu512.fa
seqkit stats negd512.fa
seqkit stats negd512d1024.fa
