...
POS_FILE = input('Enter path to protein coding sequence fasta: ')
NEG_FILE = input('Enter path to unstable sequence fasta: ')
SEQ_LENGTH = 512
...
if __name__ == "__main__":
    ...
    get_kmers('pos_testing_seqs.fa', 'neg_testing_seqs.fa', 'dev.tsv')
    print("Done!")
